...
rem 设置活动代码页,使用UTF8编码,以支持中文输入或输出.
chcp 65001
...
rem ################################主菜单的子菜单内容Start################################.
set Two_Level_Menu_Array[1].TipName=日常应用管理菜单
...
set Two_Level_Menu_Array[2].TipName=工作应用管理菜单
...
set Two_Level_Menu_Array[3].TipName=娱乐应用管理菜单
...
set Two_Level_Menu_Array[4].TipName=脚本应用管理菜单
...
set Two_Level_Menu_Array[5].TipName=脚本功能管理菜单
...
set TwoLevelMenu1[1].KillTaskName="XXXXX.exe"
...
set TwoLevelMenu2[1].KillTaskName="XXXXX.exe"
...
set TwoLevelMenu3[1].KillTaskName="XXXXX.exe"
...
set TwoLevelMenu4[1].KillTaskName="XXXXX.exe"
...
rem ################################第5个二级菜单内容Start################################.
set TwoLevelMenu5[1].TipName= 批量重命名功能
...
if defined %Local_TemTwoLevelMenuName%[%Global_ArrayIndex%].TipName (
    ...
    goto :Function_CreateTipMessage3
)
